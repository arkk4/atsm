# Чистый парс из вики
Информация по коммутатору (uptime и т.д.)
show system
...
sh interfaces brief
Показать статистику по определенному интерфейсу (1/X - номер порта)
show interface status ethernet 1/X
Показать статистику СЧЕТЧИКОВ по определенному интерфейсу - ошибки (1/X - номер порта)
show interface counters ethernet 1/X
Сбросить статистику СЧЕТЧИКОВ по определенному интерфейсу - ошибки (1/X - номер порта)
clear counters ethernet 1/Nпорта
